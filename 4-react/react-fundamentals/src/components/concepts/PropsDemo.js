        ...
        <div className='main'>
            <div className='mainDiv'>
                <div style={styles}> 
                    ...
                    <FunctionalComponent string="Why, yes it will!" function={toggleBackgroundColor} selectedStyle={backgroundColor} />
                    <FunctionalComponent string="But what about this?" function={toggleBorderRadius} selectedStyle={borderRadius} />
                    <FunctionalComponent string='Of course!' function={toggleBorderStyle} selectedStyle={borderStyle} />
                </div>
            </div>
        </div>
    );
